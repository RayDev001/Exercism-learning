...
#TODO: define the 'EXPECTED_BAKE_TIME = 40' constant.
...
def preparation_time_in_minutes(number_of_layers: int):
    ...
    Function takes the number of layers you want to add to the lasagna and assuming each layer takes 2 minutes
    to prepare it will calculate the preparation time in minutes.
    """
